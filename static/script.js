...
const menorTempo = Math.min(...tempos.filter(tempo => tempo > 0));
...
postos.forEach(posto => {
    ...
    } else if (posto.tempo_ciclo === 0) {
        step.className = 'step grey';
    } else {
